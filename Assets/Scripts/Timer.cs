...
public class Timer : MonoBehaviour
{
    ...
    void Update()
    {
        // stop timer logic if game already ended
    ...
    private void UpdateTimerDisplay(float time)
    {
        ...
        // changing to string using index and changing the value of the TMP
